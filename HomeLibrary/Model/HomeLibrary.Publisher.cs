...
namespace HomeLibrary
{
    ...
    /// <summary>
    /// There are no comments for HomeLibrary.Publisher in the schema.
    /// </summary>
    [Table(Name = @"home_library.Publishers")]
    public partial class Publisher : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Column(Storage = "_PublisherID", AutoSync = AutoSync.OnInsert, CanBeNull = false, DbType = "int(9) NOT NULL", IsDbGenerated = true, IsPrimaryKey = true)]
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Publisher_Book", Storage="_Books", ThisKey="PublisherID", OtherKey="PublisherID")]
